                        ...
                        <section class="row">
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="question" id="question" class="form-control form-control-sm" value="{{ old('question', $faq->question) }}">
                                </div>
                                @error('question')
                            ...
                            <section class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="answer" id="answer"  class="form-control form-control-sm" rows="6">{{ old('question', $faq->question) }}</textarea>
                                </div>
                                @error('answer')
                                <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                <strong>
