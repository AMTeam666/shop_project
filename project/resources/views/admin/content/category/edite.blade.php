                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group">
                                ...
                                <input name="name" type="text" class="form-control form-control-sm" id="name" value="{{ old('name',$postCategory->name) }}">
                            </div>
                            @error('name')
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group">
                                ...
                                <input name="tags" type="hidden" class="form-control form-control-sm" id="tags" value="{{ old('tags', $postCategory->tags) }}">
                            ...
                            <section class="row">
                                ...
                                <section class="col-md-{{ 6 / $number }}">
                                        <div class="form-check">
                                            <input type="radio" name="currentImage" id="{{ $number }}" class="form-check-input" value="{{ $key }}" @if($postCategory->image['currentImage'] == $key) checked @endif>
                                            <label for="{{ $number }}" class="form-check-label mx-2">
                                                <img src="{{ asset($value) }}" alt="" srcset="" class="w-100">
                                            </label>
                                        </div>
                                </section>
                                    @php
