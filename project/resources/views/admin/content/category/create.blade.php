                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group">
                                ...
                                <input name="name" type="text" class="form-control form-control-sm" id="name" value="{{ old('name') }}">
                            </div>
                            @error('name')
                        ...
                        <section class="col-12 my-2">
                            <div class="form-group">
                                ...
                                <textarea name="description" id="description"  class="form-control form-control-sm" rows="6" value="{{ old('description') }}"></textarea>
                            </div>
                            @error('description')
                            <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                    <strong>
