                        ...
                        <section class="row">
                            ...
                            <section class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="title" value="{{ old('name',$post->title) }}">
                                </div>
                                @error('title')
                                ...
                                @foreach ($post->image['indexArray'] as $key => $value)
                                    ...
                                    <section class="col-md-{{ 6 / $number }}">
                                        <div class="form-check">
                                            <input type="radio" name="currentImage" id="{{ $number }}" class="form-check-input" value="{{ $key }}" @if($post->image['currentImage'] == $key) checked @endif>
                            ...
                            <section class="col-12  ">
                                <div class="form-group">
                                    ...
                                    <input name="tags" type="hidden" class="form-control form-control-sm" id="tags" value="{{ old('tags', $post->tags) }}">
