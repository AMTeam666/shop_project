                ...
                <table class="table table-striped table-hover">
                    ...
                    @foreach($customers as $key => $customer)
                        <tr>
                            ...
                            <td>
                                <label>
                                    <input id="{{ $customer->id }}-active" onchange="changeActivation({{ $customer->id }})" data-url="{{ route('admin.user.customer.activation', $customer->id) }}" type="checkbox" @if ($customer->activation === 1)
                                        checked
                                        @endif>
                                </label>
                            </td>
