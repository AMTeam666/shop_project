                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> @if($payment->type == 0) آنلاین @elseif($payment->type == 1) آفلاین @else پرداخت نقدی @endif</td>
                            <td class="width-22-rem text-left">
                                <a href="{{ route('admin.market.payment.show', $payment->id) }}" class="btn btn-info btn-sm"><i class="fa fa-eye"></i> مشاهده</a>
                                <a href="{{ route('admin.market.payment.payed', $payment->id) }}" class="btn btn-success btn-sm"> <i class="fa fa-check"> </i>  پرداخت شده  </a>
                                <a href="{{ route('admin.market.payment.canceled', $payment->id) }}" class="btn btn-warning btn-sm"><i class="fa fa-times-circle"></i> باطل کردن</a>
