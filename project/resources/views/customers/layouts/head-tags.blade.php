...
<link rel="stylesheet" href="{{ asset('customers-assets/plugins/owlcarousel/assets/owl.carousel.min.css') }}">
<link rel="stylesheet" href="{{ asset('customers-assets/plugins/owlcarousel/assets/owl.theme.default.min.css') }}">
<link rel="stylesheet" href="{{ asset('customers-assets/css/style.css') }}">
<link rel="stylesheet" href="{{ asset('customers-assets/css/cart.css') }}">
