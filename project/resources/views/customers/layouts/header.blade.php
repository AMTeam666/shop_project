  ...
  <header class="header">
                        ...
                        <section class="header-cart-dropdown">
                            ...
                            @endphp
                                ...
                                <section class="header-cart-dropdown-body-item d-flex justify-content-start align-items-center">
                                    ...
                                    <section class="w-100 text-truncate"><a class="text-decoration-none text-dark" href="{{ route('customer.market.product', $cartItem->product) }}">{!! Str::limit($cartItem->product->name, 20) !!}</a></section>
                                    @if(!empty($cartItem->color))
                                    <span style="background-color: {{ $cartItem->color->color }};" class="cart-product-selected-color me-1"></span> 
                                    @else
                                    <span></span>
                                    @endif
                                    <section class="flex-shrink-1"><a class="text-muted text-decoration-none p-1" href="{{ route('customers.sales-process.remove-from-cart', $cartItem) }}"><i class="fa fa-trash-alt"></i></a></section>
                                </section>
                                @endforeach
                        @endif
    ...
    <!-- start menu -->
    <nav class="top-nav">
        <section class="container-xxl container-navbar">
            <nav class="">
                <section class="d-none d-md-flex justify-content-md-between position-relative">

                    <section class="super-navbar-item me-4 category-navbar">
                    ...
                    <section class="navbar-item nav-item-1"><a href="#">سوپرمارکت</a></section>
                    <section class="navbar-item nav-item-2"><a href="#">تخفیف ها و پیشنهادها</a></section>
