                    ...
                    <section class="col-md-3">
                        <section class="content-wrapper bg-white p-3 rounded-2 cart-total-price">
                            ...
                            <section class="d-flex justify-content-between align-items-center">
                                ...
                                <p class="fw-bolder"><span id="total_price">{{ priceFormat($order->order_final_amount) }}</span>
                                    تومان</p>
                            </section>
...
<script>
  $(function() {
    $('#cash_payment').click(function(){
        ...
        newDiv.innerHTML = `
            <section class="input-group input-group-sm">
                <input type="text" class="form-control name="cash_receiver" form="payment_submit" placeholder="نام و نام خانوادگی دریافت کننده">
            </section>
        `;
