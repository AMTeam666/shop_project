                    ...
                    <section class="col-md-9">
                        <section class="content-wrapper bg-white p-3 rounded-2 mb-4">
                            ...
                            <section class="address-select">
                                ...
                                <input type="radio" name="address" value="{{ $address->id }}" id="a{{ $address->id }}" />
                                <!--checked="checked"-->
                                <label for="a{{ $address->id }}" class="address-wrapper mb-2 p-2">
                                    <section class="mb-2">
                                        <i class="fa fa-map-marker-alt mx-1"></i>
                                        آدرس : {{ $address->address ?? '-' }} @if(!$address->no == null) پلاک : {{ $address->no }} @else - @endif
                                         @if(!$address->unit == null)طبقه : {{ $address->unit }} @else - @endif
                                    </section>
                                    <section class="mb-2">
                                    ...
                                    <a class="" data-bs-toggle="modal" data-bs-target="#edit-address-{{ $address->id }}"><i class="fa fa-edit"></i> ویرایش آدرس
                                    </a>
                                ...
                                <section class="address-add-wrapper">
                                    <button class="address-add-button" type="button" data-bs-toggle="modal" data-bs-target="#add-address"><i class="fa fa-plus"></i> ایجاد آدرس
                                        جدید</button>
                        ...
                        <section class="content-wrapper bg-white p-3 rounded-2 mb-4">
                            ...
                            <section class="delivery-select ">
                                ...
                                <input type="radio" name="delivery_type" value="{{ $delivery->id }}" id="d{{ $delivery->id }}" />
                                <label for="d{{ $delivery->id }}" class="col-12 col-md-4 delivery-wrapper mb-2 pt-2">
                                    ...
                                    <section class="mb-2">
                                        ...
                                        تامین کالا از  {{ $delivery->delivery_time }} {{ $delivery->delivery_time_unit }} آینده
                                    </section>
                                </label>
                                @endforeach
                    ...
                    <section class="col-md-3">
                        <section class="content-wrapper bg-white p-3 rounded-2 cart-total-price">
                            ...
                            <section class="d-flex justify-content-between align-items-center">
                                ...
                                <p class="fw-bolder"><span id="total_price">{{ priceFormat($totalProductPrice - $totalDiscount) }}</span>
                                    تومان</p>
                            </section>
