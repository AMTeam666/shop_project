                ...
                <section class="row mt-4">
                    ...
                    <section class="">
                        ...
                        <section class="content-wrapper p-3 rounded-2 mb-4">
                            ...
                            <section class="delivery-select ">
                                ...
                                <input type="radio" form="myForm" name="delivery_id" value="{{ $delivery->id }}" id="d-{{ $delivery->id }}" />
                                <label for="d-{{ $delivery->id }}" class="col-12 col-md-2 delivery-wrapper mb-2 pt-2">
                                    <section class="mb-2">
                    ...
                    <section class="">
                        <section class="content-wrapper bg-white p-3 rounded-2 cart-total-price">
                            ...
                            <form action="{{ route('customers.sales-process.chose-address-and-delivery') }}" method="POST" id="myForm">@csrf</form>

                            <section class="">
                                <button type="button" onclick="document.getElementById('myForm').submit();" class="btn btn-danger py-3 w-100 d-block button-complete-order ">تکمیل فرآیند خرید</button>
                            </section>
