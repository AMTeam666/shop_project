...
Route::prefix('admin')->namespace('Admin')->group(function (){
    ...
    //category
        Route::prefix('category')->group(function (){
            ...
            Route::get('/show_in_menu/{category}', [CategoryController::class, 'showMenu'])->name
            ('admin.market.category.show_menu');
        });
...
//            Route::patch('/update/{id}', [ContentCommentController::class, 'update'] )->name('admin.content.comment.update');
    ...
    Route::prefix('user')->namespace('User')->group(function (){
        ...
        Route::prefix('role')->group(function(){
            ...
            Route::get('/permission-form/{role}', [RoleController::class, 'permissionForm'])->name
            ('admin.user.role.permission-form');
