...
Route::prefix('admin')->namespace('Admin')->group(function () {
    ...
    Route::prefix('market')->namespace('Market')->group(function () {
        ...
        Route::prefix('brand')->group(function () {
            ...
            Route::get('/status/{brand}', [BrandController::class, 'status'])
                ->name('admin.market.brand.status');
        });
        ...
        Route::prefix('property')->group(function () {
            ...
            Route::patch('/update/{categoryAttribute}', [PropertyController::class, 'update'])->name('admin.market.property.update');
            ...
            Route::patch('/value/update/{categoryAttribute}/{value}', [PropertyValueController::class, 'update'])->name('admin.market.value.update');
    ...
    Route::prefix('user')->namespace('User')->group(function () {
        ...
        Route::prefix('customer')->group(function () {
            ...
            Route::patch('/update/{user}', [CustomerController::class, 'update'])->name('admin.user.customer.update');
            Route::delete('/destroy/{user}', [CustomerController::class, 'destroy'])->name('admin.user.customer.destroy');
            Route::get('/status/{user}', [CustomerController::class, 'status'])
        ...
        Route::prefix('role')->group(function () {
            ...
            Route::put('/permission-update/{role}', [RoleController::class, 'permissionUpdate'])
                ->name('admin.user.role.permission-update');
    ...
    Route::prefix('notify')->namespace('Notify')->group(function () {
        ...
        Route::prefix('email')->group(function () {
            ...
            Route::patch('/update/{email}', [EmailController::class, 'update'])->name('admin.notify.email.update');
        ...
        Route::prefix('email-file')->group(function () {
            ...
            Route::patch('/update/{file}', [EmailFileController::class, 'update'])->name('admin.notify.email-file.update');
        ...
        Route::prefix('sms')->group(function () {
            ...
            Route::patch('/update/{sms}', [SMSController::class, 'update'])->name('admin.notify.sms.update');
    ...
    Route::prefix('ticket')->namespace('Ticket')->group(function () {
        ...
        Route::prefix('category')->group(function () {
            ...
            Route::get('/edit/{ticketCategory}', [TicketCategoryController::class, 'edit'])
                ->name('admin.ticket.category.edit');
            Route::patch('/update/{ticketCategory}', [TicketCategoryController::class, 'update'])
                ->name('admin.ticket.category.update');
            Route::delete('/destroy/{ticketCategory}', [TicketCategoryController::class, 'destroy'])
                ->name('admin.ticket.category.destroy');
            Route::get('/status/{ticketCategory}', [TicketCategoryController::class, 'status'])
                ->name('admin.ticket.category.status');
        });
        ...
        Route::prefix('priority')->group(function () {
            ...
            Route::get('/edit/{ticketPriority}', [TicketPriorityController::class, 'edit'])
                ->name('admin.ticket.priority.edit');
            Route::patch('/update/{ticketPriority}', [TicketPriorityController::class, 'update'])
                ->name('admin.ticket.priority.update');
            Route::delete('/destroy/{ticketPriority}', [TicketPriorityController::class, 'destroy'])
                ->name('admin.ticket.priority.destroy');
            Route::get('/status/{ticketPriority}', [TicketPriorityController::class, 'status'])
                ->name('admin.ticket.priority.status');
        });
    ...
    Route::prefix('setting')->namespace('Setting')->group(function () {
        ...
        Route::patch('/update/{setting}', [SettingController::class, 'update'])->name('admin.setting.update');
...
Route::namespace('SalesProcess')->group(function () {
    ...
    //profile completion
    Route::get('/profile-completion', [ProfileCompletion::class, 'profileCompletion'])->name('customer.sales-process.profile-completion');
    Route::post('/profile-completion', [ProfileCompletion::class, 'update'])->name('customers.sales-process.profile-completion-update');
