...
class TicketPriorityController extends Controller
{
    ...
    public function store(TicketPriorityRequest $request)
    {
        ...
        return redirect()->route('admin.ticket.priority.index')->with('swal-success', 'الویت جدید شما با موفقیا ساخته شد');
    ...
    public function update(TicketPriorityRequest $request, TicketPriority $ticketPriority)
    {
        ...
        return redirect()->route('admin.ticket.priority.index')->with('swal-success', 'اولویت جدید شما با موفقیت ویرایش شد');
    }
    ...
    public function destroy(TicketPriority $ticketPriority)
    {
        ...
        return redirect()->route('admin.ticket.category.index')->with('swal-success', 'اولویت شما با موفقیت حذف شد');
    }

    public function status(TicketPriority $ticketPriority): \Illuminate\Http\JsonResponse
    {
        $ticketPriority->status = $ticketPriority->status != 0 ? 0 : 1;
