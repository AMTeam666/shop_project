...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('order_items', function (Blueprint $table) {
            ...
            $table->foreignId('product_id')->constrained('products')->onUpdate('cascade')->onDelete
            ('cascade');
            $table->longText('product');
            $table->foreignId('amazing-sale-id')->constrained('amazing_sales')->onUpdate('cascade')
                ->onDelete('cascade');
            ...
            $table->decimal('final_total_price', 20, 3)->nullable()->comment('number * final price = this column');
